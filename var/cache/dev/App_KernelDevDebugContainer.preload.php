...
(require __DIR__.'/App_KernelDevDebugContainer.php')->set(\ContainerNNYvoRC\App_KernelDevDebugContainer::class, null);
require __DIR__.'/ContainerNNYvoRC/EntityManager_9a5be93.php';
require __DIR__.'/ContainerNNYvoRC/getWebpackEncore_TagRendererService.php';
require __DIR__.'/ContainerNNYvoRC/getWebpackEncore_ExceptionListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getWebpackEncore_EntrypointLookupDefaultService.php';
require __DIR__.'/ContainerNNYvoRC/getWebProfiler_Controller_RouterService.php';
require __DIR__.'/ContainerNNYvoRC/getWebProfiler_Controller_ProfilerService.php';
require __DIR__.'/ContainerNNYvoRC/getWebProfiler_Controller_ExceptionPanelService.php';
require __DIR__.'/ContainerNNYvoRC/getValidator_NotCompromisedPasswordService.php';
require __DIR__.'/ContainerNNYvoRC/getValidator_ExpressionService.php';
require __DIR__.'/ContainerNNYvoRC/getValidator_EmailService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Runtime_SerializerService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Runtime_SecurityCsrfService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Runtime_HttpkernelService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Mailer_MessageListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Form_RendererService.php';
require __DIR__.'/ContainerNNYvoRC/getTwig_Form_EngineService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_YmlService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_XliffService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_ResService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_QtService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_PoService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_PhpService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_MoService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_JsonService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_IniService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_DatService.php';
require __DIR__.'/ContainerNNYvoRC/getTranslation_Loader_CsvService.php';
require __DIR__.'/ContainerNNYvoRC/getSession_FactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getServicesResetterService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Validator_UserPasswordService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_UserPasswordHasherService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_UserAuthenticatorService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_User_Provider_Concrete_AppUserProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_PasswordHasherFactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Logout_Listener_Default_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Logout_Listener_CsrfTokenClearingService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_UserProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_UserChecker_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_Session_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_PasswordMigratingService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_Main_UserProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_CsrfProtectionService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Listener_CheckAuthenticatorCredentialsService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_HttpUtilsService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Firewall_Map_Context_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Firewall_Map_Context_DevService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_ChannelListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_Authenticator_Manager_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_AuthenticationUtilsService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurity_AccessListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getSecrets_VaultService.php';
require __DIR__.'/ContainerNNYvoRC/getRouting_LoaderService.php';
require __DIR__.'/ContainerNNYvoRC/getPropertyInfo_SerializerExtractorService.php';
require __DIR__.'/ContainerNNYvoRC/getFragment_Renderer_InlineService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeGuesser_ValidatorService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeGuesser_DoctrineService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_Upload_ValidatorService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_Form_ValidatorService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_Form_TransformationFailureHandlingService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_Form_HttpFoundationService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_Form_DataCollectorService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_TypeExtension_CsrfService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_Type_FormService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_Type_EntityService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_Type_ColorService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_Type_ChoiceService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_ServerParamsService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_RegistryService.php';
require __DIR__.'/ContainerNNYvoRC/getForm_ChoiceListFactory_CachedService.php';
require __DIR__.'/ContainerNNYvoRC/getErrorHandler_ErrorRenderer_HtmlService.php';
require __DIR__.'/ContainerNNYvoRC/getErrorControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_UuidGeneratorService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_UlidGeneratorService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_Validator_UniqueService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_Listeners_PdoCacheAdapterDoctrineSchemaSubscriberService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_Listeners_DoctrineTokenProviderSchemaSubscriberService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_Listeners_DoctrineDbalCacheAdapterSchemaSubscriberService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_DefaultListeners_AttachEntityListenersService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Orm_DefaultEntityManager_PropertyInfoExtractorService.php';
require __DIR__.'/ContainerNNYvoRC/getDoctrine_Migrations_ContainerAwareMigrationsFactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_Voter_VoteListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_Voter_Security_Access_SimpleRoleVoterService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_Voter_Security_Access_ExpressionVoterService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_Voter_Security_Access_AuthenticatedVoterService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurityVoterService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_UserValueResolverService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_Security_Firewall_Authenticator_MainService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_FileLinkFormatter_UrlFormatService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_VariadicService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_SessionService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_ServiceService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_RequestAttributeService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_RequestService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_NotTaggedControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getDebug_ArgumentResolver_DefaultService.php';
require __DIR__.'/ContainerNNYvoRC/getBatchActionDtoResolverService.php';
require __DIR__.'/ContainerNNYvoRC/getAdminContextResolverService.php';
require __DIR__.'/ContainerNNYvoRC/getDataCollector_Request_SessionCollectorService.php';
require __DIR__.'/ContainerNNYvoRC/getContainer_GetenvService.php';
require __DIR__.'/ContainerNNYvoRC/getContainer_EnvVarProcessorsLocatorService.php';
require __DIR__.'/ContainerNNYvoRC/getContainer_EnvVarProcessorService.php';
require __DIR__.'/ContainerNNYvoRC/getCache_SystemClearerService.php';
require __DIR__.'/ContainerNNYvoRC/getCache_GlobalClearerService.php';
require __DIR__.'/ContainerNNYvoRC/getCache_AppClearerService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_SwaggerUi_ActionService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Swagger_Action_UiService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Openapi_OptionsService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Openapi_FactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Metadata_PropertySchema_OneOfRestrictionService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_View_WriteService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_View_ValidateService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_View_SerializeService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_View_RespondService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_Exception_ValidationService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Listener_ExceptionService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Jsonld_Action_ContextService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_QueryExtension_PaginationService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_QueryExtension_OrderService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_QueryExtension_FilterEagerLoadingService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_QueryExtension_FilterService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_QueryExtension_EagerLoadingService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_Default_SubresourceDataProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_Default_ItemDataProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_Default_CollectionDataProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Doctrine_Orm_DataPersisterService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Action_PlaceholderService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Action_NotFoundService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Action_ExceptionService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Action_EntrypointService.php';
require __DIR__.'/ContainerNNYvoRC/getApiPlatform_Action_DocumentationService.php';
require __DIR__.'/ContainerNNYvoRC/getTemplateControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getRedirectControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getFieldProviderService.php';
require __DIR__.'/ContainerNNYvoRC/getEntityUpdaterService.php';
require __DIR__.'/ContainerNNYvoRC/getEntityRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getFiltersFormTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getFileUploadTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getCrudFormTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getEaCrudFormTypeExtensionService.php';
require __DIR__.'/ContainerNNYvoRC/getSlugConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getNumberConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getMoneyConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getDateTimeConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getCountryConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getCommonPreConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getCommonPostConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getChoiceConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getBooleanConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getAssociationConfiguratorService.php';
require __DIR__.'/ContainerNNYvoRC/getPaginatorFactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getFormFactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getFilterFactoryService.php';
require __DIR__.'/ContainerNNYvoRC/getExceptionListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getCrudResponseListenerService.php';
require __DIR__.'/ContainerNNYvoRC/getProfilerControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getAppCustomAuthenticatorService.php';
require __DIR__.'/ContainerNNYvoRC/getUserRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getUploadRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getTaskRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getOracleTesterRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getIncidentRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getDeparementRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getComparerRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getAttachedFileRepositoryService.php';
require __DIR__.'/ContainerNNYvoRC/getUserTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getUser1TypeService.php';
require __DIR__.'/ContainerNNYvoRC/getUploadTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getTaskTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getTask1TypeService.php';
require __DIR__.'/ContainerNNYvoRC/getRegistrationFormTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getOracleTesterTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getIncidentTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getDeparementTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getComparerTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getCompareTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getAttachedFileTypeService.php';
require __DIR__.'/ContainerNNYvoRC/getUserControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getUploadControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getTaskControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getSecurityControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getRegistrationControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getOracleTesterControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getIncidentControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getHomeControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getDeparementControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getComparerControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getAttachedFileControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getUserCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getUploadCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getTaskCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getOracleTesterCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getIncidentCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getDeparementCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getDashboardControllerService.php';
require __DIR__.'/ContainerNNYvoRC/getComparerCrudControllerService.php';
require __DIR__.'/ContainerNNYvoRC/get_Session_DeprecatedService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_ZAmOOyFService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_WPLyNuLService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_QI_RhWfService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_Q6hAO0Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_L2QwsaZService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_JlYZBDkService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_JFcPcmsService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_IpvtXDOService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_GfSrDu1Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_Ch4JgvlService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_BgOZrService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_U79y_DService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_ZOQ9v2dService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_Z24SyeCService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_UDgw6OlService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_U4BbnsnService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_TtjYoNService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_TfvLzuLService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_OlybskbService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_OSbocZ8Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_Nt_OgDbService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_KfwZsneService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_KfbR3DYService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_KTfCPniService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_IZlzbt7Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_GNc8e5BService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_CoBgkqtService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_ClFhw5XService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_CKlWSjaService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_B3Rkt_QService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_8P1qXC7Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_6198kO2Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_4MF6DUvService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_4C0Bh8jService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_3on9uHLService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_2dc0eaXService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_2SV1fw8Service.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator_0gg6JHService.php';
require __DIR__.'/ContainerNNYvoRC/get_ServiceLocator__Ae5NXwService.php';
require __DIR__.'/ContainerNNYvoRC/get_Container_Private_SessionService.php';
require __DIR__.'/ContainerNNYvoRC/get_Container_Private_Form_Type_FileService.php';
require __DIR__.'/ContainerNNYvoRC/get_Container_Private_Form_FactoryService.php';
require __DIR__.'/ContainerNNYvoRC/get_Container_Private_FilesystemService.php';
require __DIR__.'/ContainerNNYvoRC/get_Container_Private_CacheClearerService.php';
...
$classes[] = 'App\Controller\Admin\ComparerCrudController';
$classes[] = 'App\Controller\Admin\DashboardController';
$classes[] = 'App\Controller\Admin\DeparementCrudController';
$classes[] = 'App\Controller\Admin\IncidentCrudController';
$classes[] = 'App\Controller\Admin\OracleTesterCrudController';
$classes[] = 'App\Controller\Admin\TaskCrudController';
$classes[] = 'App\Controller\Admin\UploadCrudController';
$classes[] = 'App\Controller\Admin\UserCrudController';
$classes[] = 'App\Controller\AttachedFileController';
$classes[] = 'App\Controller\ComparerController';
...
$classes[] = 'App\Controller\OracleTesterController';
...
$classes[] = 'App\Form\CompareType';
$classes[] = 'App\Form\ComparerType';
$classes[] = 'App\Form\DeparementType';
$classes[] = 'App\Form\IncidentType';
$classes[] = 'App\Form\OracleTesterType';
$classes[] = 'App\Form\RegistrationFormType';
$classes[] = 'App\Form\Task1Type';
...
$classes[] = 'App\Repository\ComparerRepository';
$classes[] = 'App\Repository\DeparementRepository';
$classes[] = 'App\Repository\IncidentRepository';
$classes[] = 'App\Repository\OracleTesterRepository';
