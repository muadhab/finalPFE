 ...
 */
class getDeparementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DeparementRepository' shared autowired service.
     *
     * @return \App\Repository\DeparementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DeparementRepository.php';

        return $container->privates['App\\Repository\\DeparementRepository'] = new \App\Repository\DeparementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
