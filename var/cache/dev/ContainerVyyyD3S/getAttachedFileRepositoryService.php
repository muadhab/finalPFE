 ...
 */
class getAttachedFileRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AttachedFileRepository' shared autowired service.
     *
     * @return \App\Repository\AttachedFileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AttachedFileRepository.php';

        return $container->privates['App\\Repository\\AttachedFileRepository'] = new \App\Repository\AttachedFileRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
